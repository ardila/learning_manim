...
class NeuralNetworkMobject(VGroup):
    """A manim Vgroup of neurons with edges between them"""
    ...
    def __init__(self, neural_network, neuron_fill_color, *args, **kwargs):
    ...
    def add_neurons(self):
        """Lay out the neurons in the network"""
        layers = VGroup(
            *[
    ...
    def get_nn_fill_color(self, index):
        """Get the fill color"""
        return self.neuron_fill_color

    def get_layer(self, size, index=-1):
        """Get a layer of neurons with the given size."""
        layer = VGroup()
        n_neurons = size
    ...
    def get_edge(self, neuron1, neuron2):
        """Get an edge between two neurons"""
        if self.arrow:
            return Arrow(
                neuron1.get_center(),
                neuron2.get_center(),
    ...
    def all_but_last_layer(self):
        return self.layers[:-1] + [self.edge_groups]
